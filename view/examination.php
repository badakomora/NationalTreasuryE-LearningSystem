...
<main>
    ...
    <?php 
      ...
      ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card">
                  ...
                  <div class="content">
                    ...
                    <?php 
                    if($row1['status'] == '0'){
                                $lessonsNO = mysqli_query($con, "SELECT count(*) 
                                FROM final_exam 
                                iNNER JOIN courses on courses.id=final_exam.course_id
                                WHERE final_exam.course_id ='". $row1['cid']."'");
                                while($row2 = mysqli_fetch_array($lessonsNO)){ 
                                  
                    ?>
                                 <h6><?php echo $row2['count(*)']?> Questions</h6>
                ...
                <?php if($row1['status'] == '1'){?>
                 ...
                 <?php }elseif($row1['status'] == '2'){?>
                  ...
                  <script>
                              function enrol<?php echo $row1['cid']?>(){
                                ...
                                if (enrol) {
                                  ...
                                  document.location.href='./?q=FacultyAdminCourses';
                                  }
                              }
                  </script>
                  ...
                  <?php }else{?>
                    <a href="./?q=ViewExamination&course=<?php echo $row1['cid'];?>"><button class="add" style="cursor: pointer;" id="myBtn<?php echo $row1['cid'];?>">View Questions</button></a>
                  <?php }?>
                  </div>
                </div>
              </div>
            ...
            <?php } }else{?>
       <center>
       <h6 style="color:red;">No courses to view Final Exams!</h6>
       </center>
      <?php }}?>
